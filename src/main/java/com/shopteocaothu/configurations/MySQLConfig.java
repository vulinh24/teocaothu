...
public class MySQLConfig {
	...
	protected DataSource dataSource() {
		...
		dataSourceConfig.setJdbcUrl("jdbc:mysql://localhost:3306/shopteocaothu?useUnicode=yes&characterEncoding=UTF-8");
	...
	protected LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan("com.shopteocaothu.entities"); // root

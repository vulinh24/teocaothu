            ...
            <div class="dashboard">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Chèn banner</p>
                        <div class="right__formWrapper">
                            <form:form action="${pageContext.request.contextPath}/admin/banner-add" method="post" modelAttribute="banner" enctype="multipart/form-data">
                            	<form:hidden path="id"/>

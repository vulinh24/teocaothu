...
<body>
                                    ...
                                    <tbody>
                                        <c:forEach items="${categories }" var="category" varStatus="loop">
	                                        <tr>
	                                            ...
	                                            <td data-label="Ảnh"><img alt="" src="${pageContext.request.contextPath }/upload/${category.image}" style="width: 50px;height: 50px; object-fit: cover;" ></td>
	                                            <td data-label="Tiêu đề">${category.description }</td>
	...
	function myFunction(id){
		if(confirm("Bạn có muốn xoá danh mục này ?")) {
